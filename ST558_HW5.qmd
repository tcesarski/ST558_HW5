...
#It appears that the best fit was using 33 neighbors as this gave the highest accuracy.
knn_fit
...
#This correctly predicts heart disease about 72.36% of the time.
...
#Best logistic model appears to be using logistic model 2 - using all predictors. #Give a summary of the model.
...
class_tree <- train(HeartDisease ~ ExerciseAngina*ChestPainType,
                    data = heartTrain,
                    method = "rpart",
